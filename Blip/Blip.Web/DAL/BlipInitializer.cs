...
namespace Blip.Web.DAL
{
    public class BlipInitializer : System.Data.Entity.DropCreateDatabaseAlways<BlipContext>
    {
        protected override void Seed(BlipContext context)
        {
            ...
            {
                new Message{Title="Message 1",DateTime=DateTime.Parse("2015-01-01"),Body="Message 1 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 1).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 2).SingleOrDefault() } },
                new Message{Title="Message 2",DateTime=DateTime.Parse("2015-02-01"),Body="Message 2 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 2).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 1).SingleOrDefault(), users.ToList().Where(u => u.UserID == 3).SingleOrDefault() } },
                new Message{Title="Message 3",DateTime=DateTime.Parse("2015-03-01"),Body="Message 3 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 3).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 2).SingleOrDefault(), users.ToList().Where(u => u.UserID == 4).SingleOrDefault(), users.ToList().Where(u => u.UserID == 5).SingleOrDefault() } },
                new Message{Title="Message 4",DateTime=DateTime.Parse("2015-04-01"),Body="Message 4 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 4).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 6).SingleOrDefault(), users.ToList().Where(u => u.UserID == 7).SingleOrDefault() } },
                new Message{Title="Message 5",DateTime=DateTime.Parse("2015-05-01"),Body="Message 5 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 5).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 1).SingleOrDefault(), users.ToList().Where(u => u.UserID == 3).SingleOrDefault() } },
                new Message{Title="Message 6",DateTime=DateTime.Parse("2015-06-01"),Body="Message 6 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 6).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 5).SingleOrDefault(), users.ToList().Where(u => u.UserID == 7).SingleOrDefault() } },
                new Message{Title="Message 7",DateTime=DateTime.Parse("2015-07-01"),Body="Message 7 Blip, Blip, Blip",Sender=users.ToList().Where(u => u.UserID == 7).SingleOrDefault(),Receivers= { users.ToList().Where(u => u.UserID == 1).SingleOrDefault(), users.ToList().Where(u => u.UserID == 2).SingleOrDefault(), users.ToList().Where(u => u.UserID == 3).SingleOrDefault(), users.ToList().Where(u => u.UserID == 4).SingleOrDefault() } }
            };
